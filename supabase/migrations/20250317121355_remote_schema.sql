...
CREATE POLICY "Allow all for authenticated users only" ON "public"."order_items" TO "authenticated" USING (true) WITH CHECK (true);
CREATE POLICY "Allow all for authenticated users only" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);
CREATE POLICY "Enable read access for all users" ON "public"."products" TO "authenticated" USING (true) WITH CHECK (true);
